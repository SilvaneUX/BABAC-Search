...
//    }
    ...
    override fun getAllQuery(query: String): LiveData<Resource<PagedList<TourismDataEntity>>> {
        return object :
            ...
            override fun loadFromDB(): LiveData<PagedList<TourismDataEntity>> {
                val config = PagedList.Config.Builder()
                    ...
                    .setPageSize(10)
                    .build()
                return LivePagedListBuilder(localDataSource.searchQuery(query), config).build()
            }
            ...
            override fun createCall(): LiveData<ApiResponse<List<DataItem>>> =
                remoteDataSource.searchToourism(query)
